...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2021 a las 14:11:26
...
--
DROP DATABASE IF EXISTS `iberos_daw`;
...
CREATE TABLE IF NOT EXISTS `guerreros` (
  ...
  KEY `nombre_asentamiento_2` (`nombre_asentamiento`)
...
--
ALTER TABLE `armas`
  ADD CONSTRAINT `armas_ibfk_1` FOREIGN KEY (`id_guerrero`) REFERENCES `guerreros` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `caballeria`
--
ALTER TABLE `caballeria`
  ADD CONSTRAINT `caballeria_ibfk_1` FOREIGN KEY (`codigo_org_militar`) REFERENCES `org_militar` (`codigo`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `dioses_guerreros`
--
ALTER TABLE `dioses_guerreros`
  ADD CONSTRAINT `dioses_guerreros_ibfk_1` FOREIGN KEY (`nombre_dios`) REFERENCES `dioses` (`nombre`) ON UPDATE CASCADE,
  ADD CONSTRAINT `dioses_guerreros_ibfk_2` FOREIGN KEY (`id_guerrero`) REFERENCES `guerreros` (`id`) ON UPDATE CASCADE;
...
ALTER TABLE `guerreros`
  ...
  ADD CONSTRAINT `guerreros_ibfk_2` FOREIGN KEY (`cod_org_militar`) REFERENCES `org_militar` (`codigo`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `infanteria`
--
ALTER TABLE `infanteria`
  ADD CONSTRAINT `infanteria_ibfk_1` FOREIGN KEY (`codigo_org_militar`) REFERENCES `org_militar` (`codigo`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `org_militar`
--
ALTER TABLE `org_militar`
  ADD CONSTRAINT `org_militar_ibfk_1` FOREIGN KEY (`id_lider`) REFERENCES `lider` (`id_lider`) ON UPDATE CASCADE;
COMMIT;
